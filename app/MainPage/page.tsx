...
function MainPage() {
  ...
  return (
    ...
    <div className='relative h-full w-full flex flex-col'>
      ...
      <div className='flex flex-row h-1/2 p-4 w-full items-start justify-center'>
      <div className={`h-3/4 w-1/4 p-4 flex flex-col items-center justify-start text-center mr-4 ${isPageActive ? 'translate-x-1/5 opacity-100' : '-translate-x-full opacity-0'} transition-all duration-1000`}>
      ...
      <div className={`h-3/4 w-1/4 p-4 flex flex-col items-center justify-start text-center mr-4 ${isPageActive ? 'translate-x-2/5 opacity-100' : '-translate-x-full opacity-0'} transition-all duration-1000 delay-500`}>
      ...
      <div className={`h-3/4 w-1/4 p-4 flex flex-col items-center justify-start text-center mr-4 ${isPageActive ? 'translate-x-3/5 opacity-100' : '-translate-x-full opacity-0'} transition-all duration-1000 delay-1000`}>
      ...
      <div className={`h-3/4 w-1/4 p-4 flex flex-col items-center justify-start text-center mr-4 ${isPageActive ? 'translate-x-4/5 opacity-100' : '-translate-x-full opacity-0'} transition-all duration-1000 delay-[1500ms]`}>
