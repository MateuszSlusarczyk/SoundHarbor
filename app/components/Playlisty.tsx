...
export default function Playlist() {
  ...
  return (
    <div className='h-full w-full flex flex-col items-center'>
      ...
      {tracks.map((item: any) => (
        <div className='overflow-scroll h-full min-w-1/3 md:min-w-1/6 flex flex-col items-center  bg-primary no-scrollbar p-1 pb-2 rounded-md mr-2 hover:bg-gradient-to-t from-quaternary from-0%  to-primary to-30% transition-all duration-500' data-value={item.id} onClick={PassTrack}>
      ...
      {artists.map((item: any) => (
        <div className='overflow-scroll h-full min-w-1/3 md:min-w-1/6 flex flex-col items-center  bg-primary no-scrollbar p-1 pb-2 rounded-md mr-2 hover:bg-gradient-to-t from-quaternary from-0%  to-primary to-30% transition-all duration-500' data-value={item.id} onClick={PassArtist}>
          <div className='h-3/4 md:w-1/2 sm:w-full flex justify-center items-center'>
