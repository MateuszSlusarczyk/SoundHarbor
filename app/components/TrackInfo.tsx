...
export default function TrackInfo() {
  ...
  console.log(Details.loudness);
  return (
    <div className='absolute top-10 z-0 h-screen p-4 w-5/6'>
      <div className=' w-full h-4/6 p-4 bg-primary overflow-y-scroll rounded-md flex justify-center items-center'>
        <div key={Track.name} className=' h-full w-full flex flex-col items-start bg-senary rounded-md p-2 mb-1 mt-1'>
            <div className='flex flex-row items-center justify-center h-1/2  w-full'>
            <Image src={Track.album.images[0]?.url} width="300" height="0" alt="playlista" className='rounded-md m-1 min-h-1/2 max-h-1/2 w-1/5' />
